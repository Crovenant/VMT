...
export default function DisplayTable({
  ...
  const { map: baseColumnKeyMap, allColumns: baseAllColumns } = useColumnMap(viewType)
  const { columnKeyMap, allColumns } = useMemo(() => {
    ...
    const baseMap: Record<string, string> = { ...baseColumnKeyMap }
    const baseColumns = [...baseAllColumns]
  ...
  }, [rows, baseColumnKeyMap, baseAllColumns])
  ...
  useExportExcel(gridRef as unknown as React.RefObject<{ api: GridApi }>, rows, viewType)
